...
<body>
    ...
    <div class="content">
        <div class="description">
            ...
            <div class="desc">
                <h3>Description</h3>
                <p>The meeting room is a private, fully-equipped space designed for focused collaboration and professional discussions. It features a large conference table that comfortably seats 6 to 10 people, ergonomic chairs for extended meetings, and a whiteboard for brainstorming sessions. The room includes a wall-mounted smart TV with HDMI and wireless screen-sharing capabilities, perfect for presentations and video conferences. High-speed Wi-Fi ensures seamless connectivity, while soundproofing guarantees privacy. Natural light filters through frosted glass panels, creating a bright yet discreet atmosphere.</p>
            </div>
        </div>
        <div class="request">
